...
const TabHeader: React.FC<PropsWithChildren<Props>> = ({
  children,
  onClickFullScreen,
  ...
  return (
    <>
      <div
        className="flex flex-row overflow-x-auto border-b-2 border-[color:var(--border-color)] px-3 py-2"
        style={style}
      >
        {children}
        {onClickFullScreen && onClickOutFullScreen && (
          <>
            <div
              className="ml-auto flex flex-row items-center"
              onClick={isFullScreen ? onClickOutFullScreen : onClickFullScreen}
            >
              {isFullScreen ? (
                <svg
